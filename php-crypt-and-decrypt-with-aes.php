...
function decrypter($hash, $clechiffrement) {
    ...
    $decrypted = openssl_decrypt($ciphertext_raw, $cipher, $clechiffrement, $options=OPENSSL_RAW_DATA, $iv);
    $calcmac = hash_hmac('sha256', $ciphertext_raw, $clechiffrement, $as_binary=true); //Texte déchiffré
    return $decrypted;
};
